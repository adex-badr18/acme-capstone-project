...
const CourseSection = () => {
  const courses = [
    ...
    },
    {
      ...
      category: 'Data',
      title: 'Data Analysis',
      description: 'Learn Data and Information Analysis in Decision Making.',
      rating: 3.9,
      reviews: '6,271',
      instructor: {
        name: 'Jenny Wilson',
      ...
      {[...Array(5)].map((_, index) => (
        <div key={index} className="max-w-7xl mx-auto mb-16">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Computer Proficiency</h2>
            <button className="text-blue-600 font-semibold">View Course</button>
          </div>
